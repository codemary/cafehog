...
export default class ExpoConfigView extends React.Component {
    render() {
        ...
        const sections = [
            ...
            {
                data: [{ value: manifest.loading && manifest.loading.iconUrl }],
                title: 'iconUrl',
            },
            {
                data: [
                    { value: manifest.notification && manifest.notification.iconUrl },
                ],
                title: 'notification.iconUrl',
            },
            {
                data: [{ value: manifest.notification && manifest.notification.color }],
                title: 'notification.color',
            },
            {
                data: [
                    {
                        value: manifest.ios && manifest.ios.supportsTablet
                            ? 'true'
                            : 'false',
                    },
                ],
